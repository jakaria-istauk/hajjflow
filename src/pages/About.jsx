export function About() {
  return (
    <>
      ...
      <div className="card">
        <div className="card-title">অবদান রাখুন</div>
        <div style={{ fontSize: 13, color: 'var(--text)', lineHeight: 1.8, marginBottom: 12 }}>
          নতুন ফিচার সাজেস্ট করতে বা কোডে অবদান রাখতে GitHub-এ আসুন:
        </div>
        <a
          href="https://github.com/jakaria-istauk/hajjflow"
          target="_blank"
          rel="noopener noreferrer"
          style={{
            display: 'flex', alignItems: 'center', gap: 10,
            padding: '12px 16px', borderRadius: 'var(--radius-md)',
            border: '1px solid var(--border)', background: 'var(--bg-sec)',
        ...
        >
          ...
          jakaria-istauk/hajjflow
          <span style={{ marginLeft: 'auto', fontSize: 11, color: 'var(--text-sec)' }}>GitHub →</span>
        </a>
      </div>

      <div className="card" style={{ background: 'var(--bg-sec)', border: 'none' }}>
        <div style={{ fontSize: 12, color: 'var(--text-sec)', textAlign: 'center', lineHeight: 1.8 }}>
          ভার্সন ১.০ • বাংলা ভাষায় তৈরি<br />
          <span style={{ fontSize: 16 }}>🤍</span><br />
          <i>"হজ্ব কবুল হলে পূর্ববর্তী সব গুনাহ মাফ হয়ে যায়।" — বুখারি</i>
        </div>
      </div>
    </>
  );
